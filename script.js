...
const translations = {
    ckb: {
        ...
        'designs-title': 'دیزاین و بەرهەمە جیاوازەکانمان',
        'designs-subtitle': 'بەشی تایبەت بە دیزاین و بەرهەمە جیاوازەکانمان',
        'designs-booklets': 'Booklets & Catalogs',
        'designs-booklets-desc': 'ديزاین و چاپی کەتەلوگ و نامیلکە',
        'designs-brochures': 'Brochures',
        'designs-brochures-desc': 'بروشور',
        'designs-business-cards': 'Business Cards',
        'designs-business-cards-desc': 'بزنس کارت',
        'designs-calendars': 'Calendars',
        'designs-calendars-desc': 'ساڵنامەی دیوار و سەر مێزی تایبەت',
        'designs-car-stickers': 'Car Stickers',
        'designs-car-stickers-desc': 'ستیکەری ئۆتۆمبێل',
        'designs-carbon-forms': 'Carbon Forms',
        'designs-carbon-forms-desc': 'دەفتەر وەصل',
        'designs-clocks': 'Clocks',
        'designs-clocks-desc': 'کاتژمێری دیواری',
        'designs-clothing': 'Clothing & Accessories',
        'designs-clothing-desc': 'جل و بەرگ ',
        'designs-pens': 'Custom Pens',
        'designs-pens-desc': 'پێنوس',
        'designs-desk-sets': 'Desk Sets',
        'designs-desk-sets-desc': 'سێتی سەر مێزی تایبەت',
        'designs-gift-baskets': 'Door Hangers',
        'designs-gift-baskets-desc': 'هەڵواسراوی دەرگا',
        'designs-envelopes': 'Envelopes',
        'designs-envelopes-desc': 'زەرفی نامە',
        'designs-flags': 'Flags',
        'designs-flags-desc': 'ئالا ',
        'designs-flyers': 'Flyers',
        'designs-flyers-desc': 'فڵایەر',
        'designs-folders': 'Folders',
        'designs-folders-desc': 'فۆڵدەری ',
        'designs-keychains': 'Medal',
        'designs-keychains-desc': 'میدالیا',
        'designs-labels': 'Labels & Stickers',
        'designs-labels-desc': 'لێیبڵ و ستیكەری ',
        'designs-letterheads': 'Letterheads',
        'designs-letterheads-desc': 'کلێشە',
        'designs-notepads': 'Notepads',
        'designs-notepads-desc': 'دەفتەری یاداشتەکان',
        'designs-notebooks': 'Notebooks',
        'designs-notebooks-desc': 'دەفتەری تێبینی',
        'designs-small-notepads': 'Small Notepads',
        'designs-small-notepads-desc': 'نوتپادی بچووک و گەورە',
        'designs-our-services': 'Our Services',
        'designs-our-services-desc': 'خزمەتگوزاریەکانمان',
        ...
        'designs-gift-items-desc': 'سێتی بوکس',
        'designs-advertising-products': 'Bags',
        'designs-advertising-products-desc': 'هەموو بەرهەمە ڕیکلامیەکان',
        'designs-technology': 'Advertising Technology',
        'designs-technology-desc': 'تەکنەلۆژیای  ',
        'designs-safety-items': 'Safety Items',
        'designs-safety-items-desc': 'بابەتی سەلامەتی',
        'designs-signs-banners': 'Signs & Banners',
        'designs-signs-banners-desc': ' بانەر',
